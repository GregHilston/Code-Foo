...
/**
 * testReceivedFilteredRecipesMatchExpectedIgnoringWhiteSpace - self explanatory function name
 * 
 * @param {object} filteredRecipes - recipes looked up by query and filtered by allergens
 */
function testReceivedFilteredRecipesMatchExpectedIgnoringWhiteSpace(filteredRecipes) {
